...
const getSecret = () => process.env.ADMIN_SESSION_SECRET || process.env.ADMIN_UPLOAD_PASSWORD || '';
...
export const passwordMatches = (received) => safeEqual(received, process.env.ADMIN_UPLOAD_PASSWORD);
